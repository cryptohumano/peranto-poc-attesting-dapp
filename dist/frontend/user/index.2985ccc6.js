 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Dt=function(e){return function(e){const t=At(e);return _t.encodeByteArray(t,!0)}(e).replace(/\./g,"")},Rt=function(e){try{return _t.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vt(){try{return"object"==typeof indexedDB}catch(e){return!1}}class Ut extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name="FirebaseError",Object.setPrototypeOf(this,Ut.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,$t.prototype.create)}}class $t{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const n=t[0]||{},r=`${this.service}/${e}`,i=this.errors[e],s=i?function(e,t){return e.replace(Bt,((e,n)=>{const r=t[n];return null!=r?String(r):`<${n}?>`}))}(i,n):"Error",o=`${this.serviceName}: ${s} (${r}).`;return new Ut(r,o,n)}}const Bt=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ll=new ac(Ua.comparator);function Ml(){return Ll}const Pl=new ac(Ua.comparator);function Fl(...e){let t=Pl;for(const n of e)t=t.insert(n.key,n);return t}function jl(e){let t=Pl;return e.forEach(((e,n)=>t=t.insert(e,n.overlayedDocument))),t}function Vl(){return $l()}function Ul(){return $l()}function $l(){return new Ol((e=>e.toString()),((e,t)=>e.isEqual(t)))}new ac(Ua.comparator);const Bl=new uc(Ua.comparator);function ql(...e){let t=Bl;for(const n of e)t=t.add(n);return t}const zl=new uc(Ra);function Gl(){return zl}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Iu{constructor(){this.onExistenceFilterMismatchCallbacks=new Map}static get instance(){return xu}static getOrCreateInstance(){return null===xu&&(xu=new Iu),xu}onExistenceFilterMismatch(e){const t=Symbol();return this.onExistenceFilterMismatchCallbacks.set(t,e),()=>this.onExistenceFilterMismatchCallbacks.delete(t)}notifyOnExistenceFilterMismatch(e){this.onExistenceFilterMismatchCallbacks.forEach((t=>t(e)))}}let xu=null;
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * limitations under the License.
 */
class Sh{constructor(){this.changes=new Ol((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,$c.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return void 0!==n?Wa.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ah{constructor(){this.fs=new uc(_h.ds),this.ws=new uc(_h._s)}isEmpty(){return this.fs.isEmpty()}addReference(e,t){const n=new _h(e,t);this.fs=this.fs.add(n),this.ws=this.ws.add(n)}gs(e,t){e.forEach((e=>this.addReference(e,t)))}removeReference(e,t){this.ys(new _h(e,t))}ps(e,t){e.forEach((e=>this.removeReference(e,t)))}Is(e){const t=new Ua(new Fa([])),n=new _h(t,e),r=new _h(t,e+1),i=[];return this.ws.forEachInRange([n,r],(e=>{this.ys(e),i.push(e.key)})),i}Ts(){this.fs.forEach((e=>this.ys(e)))}ys(e){this.fs=this.fs.delete(e),this.ws=this.ws.delete(e)}Es(e){const t=new Ua(new Fa([])),n=new _h(t,e),r=new _h(t,e+1);let i=ql();return this.ws.forEachInRange([n,r],(e=>{i=i.add(e.key)})),i}containsKey(e){const t=new _h(e,0),n=this.fs.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class _h{constructor(e,t){this.key=e,this.As=t}static ds(e,t){return Ua.comparator(e.key,t.key)||Ra(e.As,t.As)}static _s(e,t){return Ra(e.As,t.As)||Ua.comparator(e.key,t.key)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ud{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Eu=[],this.Au=new Map,this.vu=new Set,this.Ru=[],this.Pu=i,this.Pu.Yr((e=>{n.enqueueAndForget((async()=>{bd(this)&&(da("RemoteStore","Restarting streams for network reachability change."),await async function(e){const t=va(e);t.vu.add(4),await dd(t),t.bu.set("Unknown"),t.vu.delete(4),await hd(t)}(this))}))})),this.bu=new ld(n,r)}}async function hd(e){if(bd(e))for(const t of e.Ru)await t(!0)}async function dd(e){for(const t of e.Ru)await t(!1)}function fd(e,t){const n=va(e);n.Au.has(t.targetId)||(n.Au.set(t.targetId,t),vd(n)?yd(n):xd(n).Ko()&&md(n,t))}function pd(e,t){const n=va(e),r=xd(n);n.Au.delete(t),r.Ko()&&gd(n,t),0===n.Au.size&&(r.Ko()?r.jo():bd(n)&&n.bu.set("Unknown"))}function md(e,t){if(e.Vu.qt(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(Ma.min())>0){const n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}xd(e).su(t)}function gd(e,t){e.Vu.qt(t),xd(e).iu(t)}function yd(e){e.Vu=new Uu({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),le:t=>e.Au.get(t)||null,ue:()=>e.datastore.serializer.databaseId}),xd(e).start(),e.bu.gu()}function vd(e){return bd(e)&&!xd(e).Uo()&&e.Au.size>0}function bd(e){return 0===va(e).vu.size}function wd(e){e.Vu=void 0}async function Ed(e){e.Au.forEach(((t,n)=>{md(e,t)}))}async function Cd(e,t){wd(e),vd(e)?(e.bu.Iu(t),yd(e)):e.bu.set("Unknown")}async function Sd(e,t,n){if(e.bu.set("Online"),t instanceof ju&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const r of t.targetIds)e.Au.has(r)&&(await e.remoteSyncer.rejectListen(r,n),e.Au.delete(r),e.Vu.removeTarget(r))}(e,t)}catch(n){da("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),n),await Td(e,n)}else if(t instanceof Pu?e.Vu.Ht(t):t instanceof Fu?e.Vu.ne(t):e.Vu.Xt(t),!n.isEqual(Ma.min()))try{const t=await Bh(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.Vu.ce(t);return n.targetChanges.forEach(((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=e.Au.get(r);i&&e.Au.set(r,i.withResumeToken(n.resumeToken,t))}})),n.targetMismatches.forEach(((t,n)=>{const r=e.Au.get(t);if(!r)return;e.Au.set(t,r.withResumeToken(pc.EMPTY_BYTE_STRING,r.snapshotVersion)),gd(e,t);const i=new mh(r.target,t,n,r.sequenceNumber);md(e,i)})),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(t){da("RemoteStore","Failed to raise snapshot:",t),await Td(e,t)}}async function Td(e,t,n){if(!Ya(t))throw t;e.vu.add(1),await dd(e),e.bu.set("Offline"),n||(n=()=>Bh(e.localStore)),e.asyncQueue.enqueueRetryable((async()=>{da("RemoteStore","Retrying IndexedDB access"),await n(),e.vu.delete(1),await hd(e)}))}async function kd(e,t){const n=va(e);n.asyncQueue.verifyOperationInProgress(),da("RemoteStore","RemoteStore received new credentials");const r=bd(n);n.vu.add(3),await dd(n),r&&n.bu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.vu.delete(3),await hd(n)}async function Id(e,t){const n=va(e);t?(n.vu.delete(2),await hd(n)):t||(n.vu.add(2),await dd(n),n.bu.set("Unknown"))}function xd(e){return e.Su||(e.Su=function(e,t,n){const r=va(e);return r.fu(),new ad(t,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(e.datastore,e.asyncQueue,{uo:Ed.bind(null,e),ao:Cd.bind(null,e),nu:Sd.bind(null,e)}),e.Ru.push((async t=>{t?(e.Su.Qo(),vd(e)?yd(e):e.bu.set("Unknown")):(await e.Su.stop(),wd(e))}))),e.Su}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cf(e,t,n){if(!n)throw new wa(ba.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}function Sf(e){if(!Ua.isDocumentKey(e))throw new wa(ba.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${e} has ${e.length}.`)}function Tf(e){if(Ua.isDocumentKey(e))throw new wa(ba.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`)}function kf(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";{const t=function(e){return e.constructor?e.constructor.name:null}(e);return t?`a custom ${t} object`:"an object"}}return"function"==typeof e?"a function":ga()}function If(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new wa(ba.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=kf(e);throw new wa(ba.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${n}`)}}return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nf{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Rf(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Nf(this.firestore,e,this._key)}}class Df{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new Df(this.firestore,e,this._query)}}class Rf extends Df{constructor(e,t,n){super(e,t,yl(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Nf(this.firestore,null,new Ua(e))}withConverter(e){return new Rf(this.firestore,e,this._path)}}function Of(e,t,...n){if(e=Gt(e),Cf("collection","path",t),e instanceof Af){const r=Fa.fromString(t,...n);return Tf(r),new Rf(e,null,r)}{if(!(e instanceof Nf||e instanceof Rf))throw new wa(ba.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(Fa.fromString(t,...n));return Tf(r),new Rf(e.firestore,null,r)}}function Lf(e,t,...n){if(e=Gt(e),1===arguments.length&&(t=Da.A()),Cf("doc","path",t),e instanceof Af){const r=Fa.fromString(t,...n);return Sf(r),new Nf(e,null,new Ua(r))}{if(!(e instanceof Nf||e instanceof Rf))throw new wa(ba.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=e._path.child(Fa.fromString(t,...n));return Sf(r),new Nf(e.firestore,e instanceof Rf?e.converter:null,new Ua(r))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Uf{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Uf(pc.fromBase64String(e))}catch(e){throw new wa(ba.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new Uf(pc.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $f{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new wa(ba.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Va(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qf{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new wa(ba.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new wa(ba.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Ra(this._lat,e._lat)||Ra(this._long,e._long)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zf=/^__.*__$/;function Gf(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw ga()}}class Hf{constructor(e,t,n,r,i,s){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===i&&this.ua(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get ca(){return this.settings.ca}aa(e){return new Hf(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ha(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.aa({path:n,la:!1});return r.fa(e),r}da(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.aa({path:n,la:!1});return r.ua(),r}wa(e){return this.aa({path:void 0,la:!0})}_a(e){return np(e,this.settings.methodName,this.settings.ma||!1,this.path,this.settings.ga)}contains(e){return void 0!==this.fieldMask.find((t=>e.isPrefixOf(t)))||void 0!==this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))}ua(){if(this.path)for(let e=0;e<this.path.length;e++)this.fa(this.path.get(e))}fa(e){if(0===e.length)throw this._a("Document fields must not be empty");if(Gf(this.ca)&&zf.test(e))throw this._a('Document fields cannot begin and end with "__"')}}class Kf{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||id(e)}ya(e,t,n,r=!1){return new Hf({ca:e,methodName:t,ga:n,path:Va.emptyPath(),la:!1,ma:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Qf(e){const t=e._freezeSettings(),n=id(e._databaseId);return new Kf(e._databaseId,!!t.ignoreUndefinedProperties,n)}function Wf(e,t,n,r=!1){return Yf(n,e.ya(r?4:3,t))}function Yf(e,t){if(Zf(e=Gt(e)))return Jf("Unsupported field value:",t,e),Xf(e,t);if(e instanceof Bf)return function(e,t){if(!Gf(t.ca))throw t._a(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t._a(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.la&&4!==t.ca)throw t._a("Nested arrays are not supported");return function(e,t){const n=[];let r=0;for(const i of e){let e=Yf(i,t.wa(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=Gt(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return Ql(t.serializer,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=La.fromDate(e);return{timestampValue:Qu(t.serializer,n)}}if(e instanceof La){const n=new La(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:Qu(t.serializer,n)}}if(e instanceof qf)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof Uf)return{bytesValue:Wu(t.serializer,e._byteString)};if(e instanceof Nf){const n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t._a(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:Xu(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t._a(`Unsupported field value: ${kf(e)}`)}(e,t)}function Xf(e,t){const n={};return oc(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):sc(e,((e,r)=>{const i=Yf(r,t.ha(e));null!=i&&(n[e]=i)})),{mapValue:{fields:n}}}function Zf(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof La||e instanceof qf||e instanceof Uf||e instanceof Nf||e instanceof Bf)}function Jf(e,t,n){if(!Zf(n)||!function(e){return"object"==typeof e&&null!==e&&(Object.getPrototypeOf(e)===Object.prototype||null===Object.getPrototypeOf(e))}(n)){const r=kf(n);throw"an object"===r?t._a(e+" a custom object"):t._a(e+" "+r)}}const ep=new RegExp("[~\\*/\\[\\]]");function tp(e,t,n){if(t.search(ep)>=0)throw np(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new $f(...t.split("."))._internalPath}catch(r){throw np(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function np(e,t,n,r,i){const s=r&&!r.isEmpty(),o=void 0!==i;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=` in field ${r}`),o&&(c+=` in document ${i}`),c+=")"),new wa(ba.INVALID_ARGUMENT,a+e+c)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class rp{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new Nf(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const e=new ip(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(sp("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class ip extends rp{data(){return super.data()}}function sp(e,t){return"string"==typeof t?tp(e,t):t instanceof $f?t._internalPath:t._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function op(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new wa(ba.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class ap{}class cp extends ap{}function lp(e,t,...n){let r=[];t instanceof ap&&r.push(t),r=r.concat(n),function(e){const t=e.filter((e=>e instanceof dp)).length,n=e.filter((e=>e instanceof up)).length;if(t>1||t>0&&n>0)throw new wa(ba.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(const t of r)e=t._apply(e);return e}class up extends cp{constructor(e,t,n){super(),this._field=e,this._op=t,this._value=n,this.type="where"}static _create(e,t,n){return new up(e,t,n)}_apply(e){const t=this._parse(e);return mp(e._query,t),new Df(e.firestore,e.converter,Tl(e._query,t))}_parse(e){const t=Qf(e.firestore),n=function(e,t,n,r,i,s,o){let a;if(i.isKeyField()){if("array-contains"===s||"array-contains-any"===s)throw new wa(ba.INVALID_ARGUMENT,`Invalid Query. You can't perform '${s}' queries on documentId().`);if("in"===s||"not-in"===s){pp(o,s);const t=[];for(const n of o)t.push(fp(r,e,n));a={arrayValue:{values:t}}}else a=fp(r,e,o)}else"in"!==s&&"not-in"!==s&&"array-contains-any"!==s||pp(o,s),a=Wf(n,"where",o,"in"===s||"not-in"===s);return Qc.create(i,s,a)}(e._query,0,t,e.firestore._databaseId,this._field,this._op,this._value);return n}}function hp(e,t,n){const r=t,i=sp("where",e);return up._create(i,r,n)}class dp extends ap{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new dp(e,t)}_parse(e){const t=this._queryConstraints.map((t=>t._parse(e))).filter((e=>e.getFilters().length>0));return 1===t.length?t[0]:Wc.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return 0===t.getFilters().length?e:(function(e,t){let n=e;const r=t.getFlattenedFilters();for(const e of r)mp(n,e),n=Tl(n,e)}(e._query,t),new Df(e.firestore,e.converter,Tl(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return"and"===this.type?"and":"or"}}function fp(e,t,n){if("string"==typeof(n=Gt(n))){if(""===n)throw new wa(ba.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!El(t)&&-1!==n.indexOf("/"))throw new wa(ba.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);const r=t.path.child(Fa.fromString(n));if(!Ua.isDocumentKey(r))throw new wa(ba.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return Rc(e,new Ua(r))}if(n instanceof Nf)return Rc(e,n._key);throw new wa(ba.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${kf(n)}.`)}function pp(e,t){if(!Array.isArray(e)||0===e.length)throw new wa(ba.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${t.toString()}' filters.`)}function mp(e,t){if(t.isInequality()){const n=wl(e),r=t.field;if(null!==n&&!n.isEqual(r))throw new wa(ba.INVALID_ARGUMENT,`Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${r.toString()}'`);const i=bl(e);null!==i&&gp(e,r,i)}const n=function(e,t){for(const n of e)for(const e of n.getFlattenedFilters())if(t.indexOf(e.op)>=0)return e.op;return null}(e.filters,function(e){switch(e){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(t.op));if(null!==n)throw n===t.op?new wa(ba.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${t.op.toString()}' filter.`):new wa(ba.INVALID_ARGUMENT,`Invalid query. You cannot use '${t.op.toString()}' filters with '${n.toString()}' filters.`)}function gp(e,t,n){if(!n.isEqual(t))throw new wa(ba.INVALID_ARGUMENT,`Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${t.toString()}' and so you must also use '${t.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`)}class yp{convertValue(e,t="none"){switch(kc(e)){case 0:return null;case 1:return e.booleanValue;case 2:return yc(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(vc(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 10:return this.convertObject(e.mapValue,t);default:throw ga()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const n={};return sc(e,((e,r)=>{n[e]=this.convertValue(r,t)})),n}convertGeoPoint(e){return new qf(yc(e.latitude),yc(e.longitude))}convertArray(e,t){return(e.values||[]).map((e=>this.convertValue(e,t)))}convertServerTimestamp(e,t){switch(t){case"previous":const n=wc(e);return null==n?null:this.convertValue(n,t);case"estimate":return this.convertTimestamp(Ec(e));default:return null}}convertTimestamp(e){const t=gc(e);return new La(t.seconds,t.nanos)}convertDocumentKey(e,t){const n=Fa.fromString(e);ya(ph(n));const r=new Sc(n.get(1),n.get(3)),i=new Ua(n.popFirst(5));return r.isEqual(t)||fa(`Document ${i} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),i}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class vp{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class bp extends rp{constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new wp(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(sp("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class wp extends bp{data(e={}){return super.data(e)}}class Ep{constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new vp(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const e=[];return this.forEach((t=>e.push(t))),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach((n=>{e.call(t,new wp(this._firestore,this._userDataWriter,n.key,n,new vp(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new wa(ba.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map((n=>{const r=new wp(e._firestore,e._userDataWriter,n.doc.key,n.doc,new vp(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:t++}}))}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter((e=>t||3!==e.type)).map((t=>{const r=new wp(e._firestore,e._userDataWriter,t.doc.key,t.doc,new vp(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter);let i=-1,s=-1;return 0!==t.type&&(i=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(n=n.add(t.doc),s=n.indexOf(t.doc.key)),{type:Cp(t.type),doc:r,oldIndex:i,newIndex:s}}))}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function Cp(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return ga()}}class Sp extends yp{constructor(e){super(),this.firestore=e}convertBytes(e){return new Uf(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Nf(this.firestore,null,t)}}function Tp(e){e=If(e,Df);const t=If(e.firestore,Ff),n=jf(t),r=new Sp(t);return op(e._query),bf(n,e._query).then((n=>new Ep(t,r,e,n)))}function kp(e,...t){var n,r,i;e=Gt(e);let s={includeMetadataChanges:!1},o=0;"object"!=typeof t[o]||Pf(t[o])||(s=t[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges};if(Pf(t[o])){const e=t[o];t[o]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[o+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[o+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let c,l,u;if(e instanceof Nf)l=If(e.firestore,Ff),u=yl(e._key.path),c={next:n=>{t[o]&&t[o](Ip(l,e,n))},error:t[o+1],complete:t[o+2]};else{const n=If(e,Df);l=If(n.firestore,Ff),u=n._query;const r=new Sp(l);c={next:e=>{t[o]&&t[o](new Ep(l,r,n,e))},error:t[o+1],complete:t[o+2]},op(e._query)}return function(e,t,n,r){const i=new hf(r),s=new Ud(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>Md(await vf(e),s))),()=>{i.Dc(),e.asyncQueue.enqueueAndForget((async()=>Pd(await vf(e),s)))}}(jf(l),u,a,c)}function Ip(e,t,n){const r=n.docs.get(t._key),i=new Sp(e);return new bp(e,i,t._key,r,new vp(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
On("firebase","9.23.0","app");var xp=(l=s("jQ7Zu")).forwardRef((function({title:e,titleId:t,...n},r){return l.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true",ref:r,"aria-labelledby":t},n),e?l.createElement("title",{id:t},e):null,l.createElement("path",{fillRule:"evenodd",d:"M12.79 5.23a.75.75 0 01-.02 1.06L8.832 10l3.938 3.71a.75.75 0 11-1.04 1.08l-4.5-4.25a.75.75 0 010-1.08l4.5-4.25a.75.75 0 011.06.02z",clipRule:"evenodd"}))})),Ap=s("aLBVI"),_p=(Ap=s("aLBVI"),s("3hLxt"));async function Np(){return Ap.default.get(_p.paths.session).json()}async function Dp(e,t){const n={"x-session-id":t};await Ap.default.post(_p.paths.session,{json:e,headers:n})}const Rp=window;function Op(){return Object.entries(Rp.kilt).filter((([,e])=>e.specVersion.startsWith("3."))).map((([e])=>e))}async function Lp(e){if(!e)throw new Error("No provider");const{dAppEncryptionKeyUri:t,challenge:n,sessionId:r}=await Np(),i=await e.startSession("Peranto Attest App",t,n),{encryptionKeyUri:s,encryptedChallenge:o,nonce:a}=i;await Dp({encryptionKeyUri:s,encryptedChallenge:o,nonce:a},r);const{name:c}=e;return{...i,sessionId:r,name:c}}function Mp(e){return e instanceof Error?e:new Error(String(e))}var Pp=s("5jKHo");const Fp=["email","twitter","ine"],jp={email:{$schema:"http://kilt-protocol.org/draft-01/ctype#",title:"Email",properties:{Email:{type:"string"}},type:"object",$id:"kilt:ctype:0x3291bb126e33b4862d421bfaa1d2f272e6cdfc4f96658988fbcffea8914bd9ac"},twitter:{$schema:"http://kilt-protocol.org/draft-01/ctype#",title:"Twitter",properties:{Twitter:{type:"string"}},type:"object",$id:"kilt:ctype:0x47d04c42bdf7fdd3fc5a194bcaa367b2f4766a6b16ae3df628927656d818f420"},ine:{$schema:"http://kilt-protocol.org/draft-01/ctype#",properties:{email:{type:"string"},username:{type:"string"}},title:"Authorization",type:"object",$id:"kilt:ctype:0xdf952230c87e7fbdc8503a394540c8e99029180611e7107c4eee33f67f57aa57"}},Vp={ine:2,email:2,twitter:3};function Up(e){return Fp.includes(e)}var $p;_p=s("3hLxt");$p=new URL(s("2TGXb").resolve("lgmIG"),import.meta.url).toString();const Bp=Array.from(Tn.values()),qp=function(e,t){const n="string"==typeof e?e:t||"(default)",r=An("object"==typeof e?e:Rn(),"firestore").getImmediate({identifier:n});if(!r._initialized){const e=Mt("firestore");e&&_f(r,...e)}return r}(Bp.length>0?Bp[0]:Dn({apiKey:"AIzaSyAAwR5GvEUi3lLWy9bb1tz65jhvHI3vufc",authDomain:"peranto-test.firebaseapp.com",projectId:"peranto-test",storageBucket:"peranto-test.appspot.com",messagingSenderId:"777447831295",appId:"1:777447831295:web:6a987d7c8b307ecef43eca"})),zp=(e,t)=>t?"bg-base-100 border-none":e?"btn-error":"btn-neutral",Gp={closed:(0,a.jsx)("p",{children:"Your wallet was closed. Please try again."}),unauthorized:(0,a.jsxs)("p",{children:["The authorization was rejected. Follow the instructions on our Tech Support site to establish the connection between this attester and your wallet.",(0,a.jsx)("a",{href:"https://support.kilt.io/support/solutions/articles/80000968082-how-to-grant-access-to-website",target:"_blank",rel:"noreferrer",children:"Tech Support"})]}),unknown:(0,a.jsx)("p",{children:"Something went wrong! Try again or reload the page or restart your browser."})},Hp=({onClick:e,isError:t,isLoading:n,label:r,isSubmit:i})=>(0,a.jsx)("button",{className:`btn ${zp(t,n)} btn-active max-w-[200px]`,type:i?"submit":"button",onClick:e,children:n?(0,a.jsx)(kt.default,{visible:!0,height:"40",width:"40",ariaLabel:"dna-loading",wrapperStyle:{},wrapperClass:"dna-wrapper"}):t?"Try again":r});function Kp({onConnect:e}){const{kilt:t}=Rp,[n,r]=(0,l.useState)(Op()),[i,s]=(0,l.useState)(!1),[o,c]=(0,l.useState)();(0,l.useEffect)((()=>{function e(){r(Op())}return window.dispatchEvent(new CustomEvent("kilt-dapp#initialized")),window.addEventListener("kilt-extension#initialized",e),()=>window.removeEventListener("kilt-extension#initialized",e)}),[]);const u=(0,l.useCallback)((async n=>{try{s(!0),c(void 0),e(await Lp(t[n]))}catch(e){const{message:t}=Mp(e);t.includes("closed")?c("closed"):t.includes("Not authorized")?c("unauthorized"):(c("unknown"),console.error(e)),s(!1)}}),[e,t]);return(0,a.jsxs)("section",{className:"flex flex-col items-center gap-4 text-justify",children:[0===n.length&&(0,a.jsx)("p",{children:"Looking for a wallet… To make a claim you need to have e.g. Sporran wallet installed and have an identity configured in it."}),n.map((e=>(0,a.jsx)(Hp,{onClick:()=>u(e),isError:!!o,isLoading:i,label:`Connect to ${t[e].name}`},e))),o&&Gp[o]]})}function Qp(){const{type:e}=(0,u.useParams)(),[t,n]=(0,l.useState)(),[r,i]=(0,l.useState)("start"),[s,o]=(0,l.useState)(),[c,h]=(0,l.useState)(!1),[d,f]=(0,l.useState)(),[p,m]=(0,l.useState)(!1);(0,l.useEffect)((()=>{const e=JSON.parse(localStorage.getItem("truoraFlow_document-validation")||null);if(null!==e)if("success"===e.validation_status){const{name:t,first_last_name:n,last_name:r,date_of_birth:i,machine_readable:s}=e.details.document_details;f({fullName:`${t} ${n} ${r}`,dateOfBirth:i,ineID:s})}else m(!0),kp(Lf(qp,"truora",e.id),(e=>{const t=e.data();if(e.exists){if("success"===t?.validation_status){const{name:e,first_last_name:n,last_name:r,date_of_birth:i,machine_readable:s}=t.details.document_details;f({fullName:`${e} ${n} ${r}`,dateOfBirth:i,ineID:s})}"failure"===t?.validation_status&&f({failure:t.declined_reason}),m(!1)}}))}),[]),(0,l.useEffect)((()=>{d&&(document.querySelector('[name="email"]').value=d.ineID,document.querySelector('[name="username"]').value=d.fullName)}),[d]);const g=(0,l.useCallback)((e=>{n(e)}),[]),y=(0,l.useCallback)((async n=>{if(n.preventDefault(),o(void 0),h(!0),!t||!e||!Up(e))return;const r=Object.fromEntries(new FormData(n.currentTarget).entries());try{const{sessionId:n}=t,s={"x-session-id":n};await t.listen((async e=>{await Ap.default.post(_p.paths.requestAttestation,{headers:s,json:e}),i("requested")}));const o=await Ap.default.post(_p.paths.terms,{headers:s,json:{type:e,claimContents:r}}).json();await t.send(o)}catch(e){const{message:t}=Mp(e);t.includes("closed")||t.includes("Conflict")?o("closed"):t.includes("Not authorized")?o("unauthorized"):(o("unknown"),console.error(e))}finally{h(!1)}}),[t,e]),v=(0,l.useCallback)((async e=>{if(e.preventDefault(),o(void 0),t)try{const{sessionId:e}=t,n={"x-session-id":e};await Ap.default.post(_p.paths.pay,{headers:n}),i("paid")}catch(e){console.error(e),o("unknown")}}),[t]);if(!e||!Up(e))return(0,a.jsx)("p",{children:"Error - Unsupported CType"});const b=jp[e],{title:w,properties:E}=b;return(0,a.jsx)("section",{className:"bg-base-200 min-h-screen flex flex-col justify-center",children:(0,a.jsx)("div",{className:"container mx-auto max-w-5xl card flex-shrink-0 w-full max-w-lg shadow-2xl bg-base-100",children:(0,a.jsxs)("div",{className:"card-body flex flex-col gap-4",children:[(0,a.jsx)("div",{className:"relative",children:(0,a.jsx)(u.Link,{to:Pp.paths.home,className:"absolute -top-7 -left-2 text-xs flex items-center btn btn-link p-0 m-0",children:(0,a.jsx)(xp,{className:"w-6"})})}),(0,a.jsxs)("div",{className:"flex justify-between items-end mt-2",children:[(0,a.jsx)("h2",{className:"text-xl",children:"Authorization"===w?"INE":w}),(0,a.jsxs)("span",{children:["Price: ",Vp[e]," KILT"]})]}),(0,a.jsxs)("div",{className:"flex flex-col items-center",children:[(0,a.jsxs)("form",{className:"my-2 flex flex-col items-center",onSubmit:y,children:["start"===r&&"ine"===e&&(0,a.jsxs)(a.Fragment,{children:[!p&&d?.failure?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("p",{className:"text-red",children:"Validation not successful"}),(0,a.jsx)("br",{}),(0,a.jsxs)("span",{className:"text-red-400 mb-8",children:[(0,a.jsx)("span",{className:"font-bold text-red-600",children:"Error: "}),d.failure]})]}):d?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("p",{children:"Validation successful!"}),(0,a.jsx)("br",{}),(0,a.jsxs)("table",{className:"table mb-8",children:[(0,a.jsxs)("tr",{children:[(0,a.jsx)("td",{children:"Name: "}),(0,a.jsx)("td",{className:"break-all",children:d.fullName})]}),(0,a.jsxs)("tr",{children:[(0,a.jsx)("td",{children:"Date of birth:"}),(0,a.jsx)("td",{className:"break-all",children:d.dateOfBirth})]}),(0,a.jsxs)("tr",{children:[(0,a.jsx)("td",{children:"INE"}),(0,a.jsx)("td",{className:"break-all",children:d.ineID})]})]})]}):null,!p&&d?.failure&&(0,a.jsx)("button",{className:"btn btn-error mb-8",onClick:()=>{localStorage.removeItem("truoraFlow_document-validation"),location.reload()},children:"Try Truora validation again"}),!p&&!d&&(0,a.jsx)("a",{className:"btn btn-info mt-4 mb-8",href:"https://identity.truora.com/preview/IPFcbd9b16226d31a44b0b22eda776afd0d",children:"Validation with Truora"}),p&&(0,a.jsx)("p",{className:"mt-4 mb-8",children:"Waiting for Truora response."}),(0,a.jsx)(a.Fragment,{children:Object.keys(E).map((e=>(0,a.jsxs)("label",{className:"hidden",children:[e,":",(0,a.jsx)("input",{name:e,disabled:!t,required:!0})]},e)))})]}),"start"===r&&"ine"!==e&&(0,a.jsx)(a.Fragment,{children:(0,a.jsx)(a.Fragment,{children:Object.keys(E).map((e=>(0,a.jsxs)("label",{children:[e,":",(0,a.jsx)("input",{name:e,disabled:!t,required:!0})]},e)))})}),!t&&(0,a.jsx)(Kp,{onConnect:g}),t&&(0,a.jsx)(Hp,{isLoading:c,isError:!!s,label:"Submit",isSubmit:!0})]}),"requested"===r&&(0,a.jsxs)("form",{onSubmit:v,children:[(0,a.jsx)("p",{children:"Thanks for your request. Please pay"}),(0,a.jsx)("button",{children:"Pay"})]}),"paid"===r&&(0,a.jsx)("p",{children:"Thanks for your payment! Your request has been sent to the attester for processing. You can check the attestation status in your wallet."}),s&&Gp[s]]})]})})})}function Wp(){return(0,l.useEffect)((()=>{const e=new URLSearchParams(window.location.search),t=e.get("process_id"),n=e.get("account_id");t&&n&&(async()=>{const e=lp(Of(qp,"truora"),hp("account_id","==",n),hp("identity_process_id","==",t)),r=await Tp(e);let i={};r.forEach((e=>{i={...e.data(),id:e.id}})),localStorage.setItem(`truoraFlow_${i.type}`,JSON.stringify(i)),"document-validation"===i.type&&location.replace("/claim/ine")})()}),[]),(0,a.jsx)("section",{className:"bg-base-200 ",style:{backgroundImage:`url(${t($p)})`,backgroundRepeat:"no-repeat",backgroundSize:"369px auto",backgroundPosition:"center 60px"},children:(0,a.jsx)("div",{className:"hero min-h-screen container mx-auto max-w-5xl",children:(0,a.jsxs)("div",{className:"hero-content flex-col lg:flex-row",children:[(0,a.jsxs)("div",{className:"flex flex-col text-center lg:text-left",children:[(0,a.jsx)("h1",{className:"text-5xl font-bold text-[#1b2a51]",children:"Attest App"}),(0,a.jsx)("p",{className:"py-6 text-[#1b2a51]",children:"This KILT Attester Example demonstrates how to issue credentials for a couple basic claim types which already exist on the KILT blockchain. The user chooses a claim type, enters the claim data, makes a (mock) payment, and the claim is sent to the attester to be reviewed."})]}),(0,a.jsx)("div",{className:"card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100",children:(0,a.jsxs)("div",{className:"card-body",children:[(0,a.jsx)("p",{className:"text-[#1b2a51]",children:"Start selecting a claim type:"}),(0,a.jsx)("ul",{className:"menu w-56 rounded-box",children:Fp.map(((e,t)=>(0,a.jsx)("li",{children:(0,a.jsxs)(u.Link,{className:"link text-[#1b2a51]",to:(0,u.generatePath)(Pp.paths.claim,{type:e}),children:[0===t&&(0,a.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-5 w-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,a.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"})}),1===t&&(0,a.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-5 w-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,a.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"})}),2===t&&(0,a.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",className:"h-5 w-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,a.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"})}),"Authorization"===jp[e].title?"INE":jp[e].title]})},e)))})]})})]})})})}(0,c.createRoot)(document.querySelector("#app")).render((0,a.jsx)(u.BrowserRouter,{children:(0,a.jsxs)(u.Routes,{children:[(0,a.jsx)(u.Route,{path:Pp.paths.home,element:(0,a.jsx)(Wp,{})}),(0,a.jsx)(u.Route,{path:Pp.paths.claim,element:(0,a.jsx)(Qp,{})}),(0,a.jsx)(u.Route,{path:"*",element:(0,a.jsx)("p",{children:"404 - Not found"})})]})}));
//# sourceMappingURL=index.2985ccc6.js.map
