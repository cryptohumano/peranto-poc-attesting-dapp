 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $r{constructor(t){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,t((t=>{this.isDone=!0,this.result=t,this.nextCallback&&this.nextCallback(t)}),(t=>{this.isDone=!0,this.error=t,this.catchCallback&&this.catchCallback(t)}))}catch(t){return this.next(void 0,t)}next(t,e){return this.callbackAttached&&ur(),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(e,this.error):this.wrapSuccess(t,this.result):new $r(((n,s)=>{this.nextCallback=e=>{this.wrapSuccess(t,e).next(n,s)},this.catchCallback=t=>{this.wrapFailure(e,t).next(n,s)}}))}toPromise(){return new Promise(((t,e)=>{this.next(t,e)}))}wrapUserFunction(t){try{const e=t();return e instanceof $r?e:$r.resolve(e)}catch(t){return $r.reject(t)}}wrapSuccess(t,e){return t?this.wrapUserFunction((()=>t(e))):$r.resolve(e)}wrapFailure(t,e){return t?this.wrapUserFunction((()=>t(e))):$r.reject(e)}static resolve(t){return new $r(((e,n)=>{e(t)}))}static reject(t){return new $r(((e,n)=>{n(t)}))}static waitFor(t){return new $r(((e,n)=>{let s=0,i=0,r=!1;t.forEach((t=>{++s,t.next((()=>{++i,r&&i===s&&e()}),(t=>n(t)))})),r=!0,i===s&&e()}))}static or(t){let e=$r.resolve(!1);for(const n of t)e=e.next((t=>t?$r.resolve(t):n()));return e}static forEach(t,e){const n=[];return t.forEach(((t,s)=>{n.push(e.call(this,t,s))})),this.waitFor(n)}static mapArray(t,e){return new $r(((n,s)=>{const i=t.length,r=new Array(i);let o=0;for(let a=0;a<i;a++){const c=a;e(t[c]).next((t=>{r[c]=t,++o,o===i&&n(r)}),(t=>s(t)))}}))}static doWhile(t,e){return new $r(((n,s)=>{const i=()=>{!0===t()?e().next((()=>{i()}),s):n()};i()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ja{constructor(){this._=void 0}}function Ba(t,e,n){return t instanceof za?function(t,e){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:t.seconds,nanos:t.nanoseconds}}}};return e&&fo(e)&&(e=po(e)),e&&(n.fields.__previous_value__=e),{mapValue:n}}(n,e):t instanceof Ka?Ha(t,e):t instanceof Ga?Wa(t,e):function(t,e){const n=$a(t,e),s=Ya(n)+Ya(t.gt);return Ao(n)&&Ao(t.gt)?Ua(s):Va(t.serializer,s)}(t,e)}function qa(t,e,n){return t instanceof Ka?Ha(t,e):t instanceof Ga?Wa(t,e):n}function $a(t,e){var n;return t instanceof Qa?Ao(n=e)||function(t){return!!t&&"doubleValue"in t}(n)?e:{integerValue:0}:null}class za extends ja{}class Ka extends ja{constructor(t){super(),this.elements=t}}function Ha(t,e){const n=Xa(e);for(const e of t.elements)n.some((t=>bo(t,e)))||n.push(e);return{arrayValue:{values:n}}}class Ga extends ja{constructor(t){super(),this.elements=t}}function Wa(t,e){let n=Xa(e);for(const e of t.elements)n=n.filter((t=>!bo(t,e)));return{arrayValue:{values:n}}}class Qa extends ja{constructor(t,e){super(),this.serializer=t,this.gt=e}}function Ya(t){return uo(t.integerValue||t.doubleValue)}function Xa(t){return _o(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class uh{constructor(){this.rn=new lh}addToCollectionParentIndex(t,e){return this.rn.add(e),$r.resolve()}getCollectionParents(t,e){return $r.resolve(this.rn.getEntries(e))}addFieldIndex(t,e){return $r.resolve()}deleteFieldIndex(t,e){return $r.resolve()}getDocumentsMatchingTarget(t,e){return $r.resolve(null)}getIndexType(t,e){return $r.resolve(0)}getFieldIndexes(t,e){return $r.resolve([])}getNextCollectionGroupToUpdate(t){return $r.resolve(null)}getMinOffset(t,e){return $r.resolve(Vr.min())}getMinOffsetFromCollectionGroup(t,e){return $r.resolve(Vr.min())}updateCollectionGroup(t,e,n){return $r.resolve()}updateIndexEntries(t,e){return $r.resolve()}}class lh{constructor(){this.index={}}add(t){const e=t.lastSegment(),n=t.popLast(),s=this.index[e]||new so(xr.comparator),i=!s.has(n);return this.index[e]=s.add(n),i}has(t){const e=t.lastSegment(),n=t.popLast(),s=this.index[e];return s&&s.has(n)}getEntries(t){return(this.index[t]||new so(xr.comparator)).toArray()}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yh{constructor(t){this.serializer=t,this.cs=new Map,this.hs=new Map}getBundleMetadata(t,e){return $r.resolve(this.cs.get(e))}saveBundleMetadata(t,e){var n;return this.cs.set(e.id,{id:(n=e).id,version:n.version,createTime:Bc(n.createTime)}),$r.resolve()}getNamedQuery(t,e){return $r.resolve(this.hs.get(e))}saveNamedQuery(t,e){return this.hs.set(e.name,function(t){return{name:t.name,query:ch(t.bundledQuery),readTime:Bc(t.readTime)}}(e)),$r.resolve()}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vh{constructor(){this.overlays=new to(Or.comparator),this.ls=new Map}getOverlay(t,e){return $r.resolve(this.overlays.get(e))}getOverlays(t,e){const n=xa();return $r.forEach(e,(e=>this.getOverlay(t,e).next((t=>{null!==t&&n.set(e,t)})))).next((()=>n))}saveOverlays(t,e,n){return n.forEach(((n,s)=>{this.we(t,e,s)})),$r.resolve()}removeOverlaysForBatchId(t,e,n){const s=this.ls.get(n);return void 0!==s&&(s.forEach((t=>this.overlays=this.overlays.remove(t))),this.ls.delete(n)),$r.resolve()}getOverlaysForCollection(t,e,n){const s=xa(),i=e.length+1,r=new Or(e.child("")),o=this.overlays.getIteratorFrom(r);for(;o.hasNext();){const t=o.getNext().value,r=t.getKey();if(!e.isPrefixOf(r.path))break;r.path.length===i&&t.largestBatchId>n&&s.set(t.getKey(),t)}return $r.resolve(s)}getOverlaysForCollectionGroup(t,e,n,s){let i=new to(((t,e)=>t-e));const r=this.overlays.getIterator();for(;r.hasNext();){const t=r.getNext().value;if(t.getKey().getCollectionGroup()===e&&t.largestBatchId>n){let e=i.get(t.largestBatchId);null===e&&(e=xa(),i=i.insert(t.largestBatchId,e)),e.set(t.getKey(),t)}}const o=xa(),a=i.getIterator();for(;a.hasNext()&&(a.getNext().value.forEach(((t,e)=>o.set(t,e))),!(o.size()>=s)););return $r.resolve(o)}we(t,e,n){const s=this.overlays.get(n.key);if(null!==s){const t=this.ls.get(s.largestBatchId).delete(n.key);this.ls.set(s.largestBatchId,t)}this.overlays=this.overlays.insert(n.key,new dc(e,n));let i=this.ls.get(e);void 0===i&&(i=Ma(),this.ls.set(e,i)),this.ls.set(e,i.add(n.key))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eh{constructor(t,e){this.indexManager=t,this.referenceDelegate=e,this.mutationQueue=[],this.vs=1,this.Rs=new so(bh.ds)}checkEmpty(t){return $r.resolve(0===this.mutationQueue.length)}addMutationBatch(t,e,n,s){const i=this.vs;this.vs++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const r=new lc(i,e,n,s);this.mutationQueue.push(r);for(const e of s)this.Rs=this.Rs.add(new bh(e.key,i)),this.indexManager.addToCollectionParentIndex(t,e.key.path.popLast());return $r.resolve(r)}lookupMutationBatch(t,e){return $r.resolve(this.Ps(e))}getNextMutationBatchAfterBatchId(t,e){const n=e+1,s=this.bs(n),i=s<0?0:s;return $r.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return $r.resolve(0===this.mutationQueue.length?-1:this.vs-1)}getAllMutationBatches(t){return $r.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,e){const n=new bh(e,0),s=new bh(e,Number.POSITIVE_INFINITY),i=[];return this.Rs.forEachInRange([n,s],(t=>{const e=this.Ps(t.As);i.push(e)})),$r.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(t,e){let n=new so(Ar);return e.forEach((t=>{const e=new bh(t,0),s=new bh(t,Number.POSITIVE_INFINITY);this.Rs.forEachInRange([e,s],(t=>{n=n.add(t.As)}))})),$r.resolve(this.Vs(n))}getAllMutationBatchesAffectingQuery(t,e){const n=e.path,s=n.length+1;let i=n;Or.isDocumentKey(i)||(i=i.child(""));const r=new bh(new Or(i),0);let o=new so(Ar);return this.Rs.forEachWhile((t=>{const e=t.key.path;return!!n.isPrefixOf(e)&&(e.length===s&&(o=o.add(t.As)),!0)}),r),$r.resolve(this.Vs(o))}Vs(t){const e=[];return t.forEach((t=>{const n=this.Ps(t);null!==n&&e.push(n)})),e}removeMutationBatch(t,e){lr(0===this.Ss(e.batchId,"removed")),this.mutationQueue.shift();let n=this.Rs;return $r.forEach(e.mutations,(s=>{const i=new bh(s.key,e.batchId);return n=n.delete(i),this.referenceDelegate.markPotentiallyOrphaned(t,s.key)})).next((()=>{this.Rs=n}))}Cn(t){}containsKey(t,e){const n=new bh(e,0),s=this.Rs.firstAfterOrEqual(n);return $r.resolve(e.isEqual(s&&s.key))}performConsistencyCheck(t){return this.mutationQueue.length,$r.resolve()}Ss(t,e){return this.bs(t)}bs(t){return 0===this.mutationQueue.length?0:t-this.mutationQueue[0].batchId}Ps(t){const e=this.bs(t);return e<0||e>=this.mutationQueue.length?null:this.mutationQueue[e]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Th{constructor(t){this.Ds=t,this.docs=new to(Or.comparator),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const n=e.key,s=this.docs.get(n),i=s?s.size:0,r=this.Ds(e);return this.docs=this.docs.insert(n,{document:e.mutableCopy(),size:r}),this.size+=r-i,this.indexManager.addToCollectionParentIndex(t,n.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const n=this.docs.get(e);return $r.resolve(n?n.document.mutableCopy():Oo.newInvalidDocument(e))}getEntries(t,e){let n=_a();return e.forEach((t=>{const e=this.docs.get(t);n=n.insert(t,e?e.document.mutableCopy():Oo.newInvalidDocument(t))})),$r.resolve(n)}getDocumentsMatchingQuery(t,e,n,s){let i=_a();const r=e.path,o=new Or(r.child("")),a=this.docs.getIteratorFrom(o);for(;a.hasNext();){const{key:t,value:{document:o}}=a.getNext();if(!r.isPrefixOf(t.path))break;t.path.length>r.length+1||Ur(Fr(o),n)<=0||(s.has(o.key)||Ea(e,o))&&(i=i.insert(o.key,o.mutableCopy()))}return $r.resolve(i)}getAllFromCollectionGroup(t,e,n,s){ur()}Cs(t,e){return $r.forEach(this.docs,(t=>e(t)))}newChangeBuffer(t){return new Ch(this)}getSize(t){return $r.resolve(this.size)}}class Ch extends ph{constructor(t){super(),this.os=t}applyChanges(t){const e=[];return this.changes.forEach(((n,s)=>{s.isValidDocument()?e.push(this.os.addEntry(t,s)):this.os.removeEntry(n)})),$r.waitFor(e)}getFromCache(t,e){return this.os.getEntry(t,e)}getAllFromCache(t,e){return this.os.getEntries(t,e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sh{constructor(t){this.persistence=t,this.xs=new Ia((t=>ra(t)),oa),this.lastRemoteSnapshotVersion=kr.min(),this.highestTargetId=0,this.Ns=0,this.ks=new wh,this.targetCount=0,this.Ms=fh.kn()}forEachTarget(t,e){return this.xs.forEach(((t,n)=>e(n))),$r.resolve()}getLastRemoteSnapshotVersion(t){return $r.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(t){return $r.resolve(this.Ns)}allocateTargetId(t){return this.highestTargetId=this.Ms.next(),$r.resolve(this.highestTargetId)}setTargetsMetadata(t,e,n){return n&&(this.lastRemoteSnapshotVersion=n),e>this.Ns&&(this.Ns=e),$r.resolve()}Fn(t){this.xs.set(t.target,t);const e=t.targetId;e>this.highestTargetId&&(this.Ms=new fh(e),this.highestTargetId=e),t.sequenceNumber>this.Ns&&(this.Ns=t.sequenceNumber)}addTargetData(t,e){return this.Fn(e),this.targetCount+=1,$r.resolve()}updateTargetData(t,e){return this.Fn(e),$r.resolve()}removeTargetData(t,e){return this.xs.delete(e.target),this.ks.Is(e.targetId),this.targetCount-=1,$r.resolve()}removeTargets(t,e,n){let s=0;const i=[];return this.xs.forEach(((r,o)=>{o.sequenceNumber<=e&&null===n.get(o.targetId)&&(this.xs.delete(r),i.push(this.removeMatchingKeysForTargetId(t,o.targetId)),s++)})),$r.waitFor(i).next((()=>s))}getTargetCount(t){return $r.resolve(this.targetCount)}getTargetData(t,e){const n=this.xs.get(e)||null;return $r.resolve(n)}addMatchingKeys(t,e,n){return this.ks.gs(e,n),$r.resolve()}removeMatchingKeys(t,e,n){this.ks.ps(e,n);const s=this.persistence.referenceDelegate,i=[];return s&&e.forEach((e=>{i.push(s.markPotentiallyOrphaned(t,e))})),$r.waitFor(i)}removeMatchingKeysForTargetId(t,e){return this.ks.Is(e),$r.resolve()}getMatchingKeysForTargetId(t,e){const n=this.ks.Es(e);return $r.resolve(n)}containsKey(t,e){return $r.resolve(this.ks.containsKey(e))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $h=null;function zh(){return null===$h?$h=268435456+Math.round(2147483648*Math.random()):$h++,"0x"+$h.toString(16)
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
_t("firebase","9.23.0","app");var Hl=s("aLBVI"),Gl=(Hl=s("aLBVI"),s("3hLxt"));async function Wl(){return Hl.default.get(Gl.paths.session).json()}async function Ql(t,e){const n={"x-session-id":e};await Hl.default.post(Gl.paths.session,{json:t,headers:n})}const Yl=window;function Xl(){return Object.entries(Yl.kilt).filter((([,t])=>t.specVersion.startsWith("3."))).map((([t])=>t))}async function Jl(t){if(!t)throw new Error("No provider");const{dAppEncryptionKeyUri:e,challenge:n,sessionId:s}=await Wl(),i=await t.startSession("CertifiedProof",e,n),{encryptionKeyUri:r,encryptedChallenge:o,nonce:a}=i;await Ql({encryptionKeyUri:r,encryptedChallenge:o,nonce:a},s);const{name:c}=t;return{...i,sessionId:s,name:c}}function Zl(t){return t instanceof Error?t:new Error(String(t))}var td=s("5jKHo");const ed=["email","twitter","id"],nd={email:{$schema:"http://kilt-protocol.org/draft-01/ctype#",title:"Email",properties:{Email:{type:"string"}},type:"object",$id:"kilt:ctype:0x3291bb126e33b4862d421bfaa1d2f272e6cdfc4f96658988fbcffea8914bd9ac"},twitter:{$schema:"http://kilt-protocol.org/draft-01/ctype#",title:"Twitter",properties:{Twitter:{type:"string"}},type:"object",$id:"kilt:ctype:0x47d04c42bdf7fdd3fc5a194bcaa367b2f4766a6b16ae3df628927656d818f420"},id:{$schema:"http://kilt-protocol.org/draft-01/ctype#",properties:{age:{type:"integer"},name:{type:"string"}},title:"INE ID",type:"object",$id:"kilt:ctype:0xa742f2eb8ba8d939c9ccd1332511fa284c528a57b36bd33c3168b11da31a3366"}},sd={id:2,email:2,twitter:3};function id(t){return ed.includes(t)}Gl=s("3hLxt");const rd=Array.from(vt.values()),od=function(t,e){const n="string"==typeof t?t:e||"(default)",s=Tt("object"==typeof t?t:At(),"firestore").getImmediate({identifier:n});if(!s._initialized){const t=N("firestore");t&&yl(s,...t)}return s}(rd.length>0?rd[0]:It({apiKey:"AIzaSyAAwR5GvEUi3lLWy9bb1tz65jhvHI3vufc",authDomain:"peranto-test.firebaseapp.com",projectId:"peranto-test",storageBucket:"peranto-test.appspot.com",messagingSenderId:"777447831295",appId:"1:777447831295:web:6a987d7c8b307ecef43eca"})),ad={closed:(0,a.jsx)("p",{children:"Your wallet was closed. Please try again."}),unauthorized:(0,a.jsxs)("p",{children:["The authorization was rejected. Follow the instructions on our Tech Support site to establish the connection between this attester and your wallet.",(0,a.jsx)("a",{href:"https://support.kilt.io/support/solutions/articles/80000968082-how-to-grant-access-to-website",target:"_blank",rel:"noreferrer",children:"Tech Support"})]}),unknown:(0,a.jsx)("p",{children:"Something went wrong! Try again or reload the page or restart your browser."})};function cd({onConnect:t}){const{kilt:e}=Yl,[n,s]=(0,h.useState)(Xl()),[i,r]=(0,h.useState)(!1),[o,c]=(0,h.useState)();(0,h.useEffect)((()=>{function t(){s(Xl())}return window.dispatchEvent(new CustomEvent("kilt-dapp#initialized")),window.addEventListener("kilt-extension#initialized",t),()=>window.removeEventListener("kilt-extension#initialized",t)}),[]);const u=(0,h.useCallback)((async n=>{try{r(!0),c(void 0),t(await Jl(e[n]))}catch(t){const{message:e}=Zl(t);e.includes("closed")?c("closed"):e.includes("Not authorized")?c("unauthorized"):(c("unknown"),console.error(t)),r(!1)}}),[t,e]);return(0,a.jsxs)("section",{children:[0===n.length&&(0,a.jsx)("p",{children:"Looking for a wallet… To make a claim you need to have e.g. Sporran wallet installed and have an identity configured in it."}),n.map((t=>(0,a.jsxs)("button",{className:"btn btn-active btn-primary",type:"button",onClick:()=>u(t),children:["Connect to ",e[t].name]},t))),i&&(0,a.jsx)("p",{children:"Connecting…"}),o&&ad[o]]})}function hd(){const{type:t}=(0,u.useParams)(),[e,n]=(0,h.useState)(""),[s,i]=(0,h.useState)(),[r,o]=(0,h.useState)("start"),[c,l]=(0,h.useState)();(0,h.useEffect)((()=>{e&&zl(El(od,"metamap","testId_verification_started"),(t=>{const e=t.data(),n=JSON.parse(e.payload).documents[0],s=function(t){const e=Date.now()-t.getTime(),n=new Date(e);return Math.abs(n.getUTCFullYear()-1970)}(new Date(n.fields.dateOfBirth.value)),i=n.fields.fullName.value;document.querySelector('[name="name"]').value=i,document.querySelector('[name="age"]').value=s}))}),[e]);const d=(0,h.useCallback)((t=>{i(t)}),[]),f=(0,h.useCallback)((async e=>{if(e.preventDefault(),l(void 0),!s||!t||!id(t))return;const n=Object.fromEntries(new FormData(e.currentTarget).entries());try{const{sessionId:e}=s,i={"x-session-id":e};await s.listen((async t=>{await Hl.default.post(Gl.paths.requestAttestation,{headers:i,json:t}),o("requested")}));const r=await Hl.default.post(Gl.paths.terms,{headers:i,json:{type:t,claimContents:n}}).json();await s.send(r)}catch(t){const{message:e}=Zl(t);e.includes("closed")||e.includes("Conflict")?l("closed"):e.includes("Not authorized")?l("unauthorized"):(l("unknown"),console.error(t))}}),[s,t]),p=(0,h.useCallback)((async t=>{if(t.preventDefault(),l(void 0),s)try{const{sessionId:t}=s,e={"x-session-id":t};await Hl.default.post(Gl.paths.pay,{headers:e}),o("paid")}catch(t){console.error(t),l("unknown")}}),[s]);if(!t||!id(t))return(0,a.jsx)("p",{children:"Error - Unsupported CType"});const g=nd[t],{title:m,properties:y}=g;return(0,a.jsxs)("section",{children:[(0,a.jsx)("h2",{children:m}),(0,a.jsxs)("p",{className:"mb-4",children:["Price: ",sd[t]," KILT"]}),"start"===r&&"id"===t&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("div",{onMouseEnter:()=>{document.querySelector("mati-button")?.addEventListener("mati:userStartedSdk",(({detail:t})=>{n(t.verificationId)}))},children:(0,a.jsx)("mati-button",{clientid:"64811ce44d683b001b9013f0",flowId:"64811ce44d683b001b9013ef"})}),(0,a.jsxs)("form",{className:"my-2",onSubmit:f,children:[Object.keys(y).map((t=>(0,a.jsxs)("label",{className:"hidden",children:[t,":",(0,a.jsx)("input",{name:t,disabled:!s,required:!0})]},t))),!s&&(0,a.jsx)(cd,{onConnect:d}),s&&(0,a.jsx)("button",{className:"btn btn-active btn-primary",type:"submit",children:"Submit"})]})]}),"start"===r&&"id"!==t&&(0,a.jsx)(a.Fragment,{children:(0,a.jsxs)("form",{onSubmit:f,children:[Object.keys(y).map((t=>(0,a.jsxs)("label",{children:[t,":",(0,a.jsx)("input",{name:t,disabled:!s,required:!0})]},t))),!s&&(0,a.jsx)(cd,{onConnect:d}),s&&(0,a.jsx)("button",{className:"btn btn-active btn-primary",type:"submit",children:"Submit"})]})}),"requested"===r&&(0,a.jsxs)("form",{onSubmit:p,children:[(0,a.jsx)("p",{children:"Thanks for your request. Please pay"}),(0,a.jsx)("button",{children:"Pay"})]}),"paid"===r&&(0,a.jsx)("p",{children:"Thanks for your payment! Your request has been sent to the attester for processing. You can check the attestation status in your wallet."}),c&&ad[c],(0,a.jsx)(u.Link,{to:td.paths.home,children:"Back"})]})}function ud(){return(0,a.jsxs)("section",{children:[(0,a.jsx)("h1",{className:"my-4",children:"CertifiedProof"}),(0,a.jsx)("p",{children:"This KILT Attester Example demonstrates how to issue credentials for a couple basic claim types which already exist on the KILT blockchain. The user chooses a claim type, enters the claim data, makes a (mock) payment, and the claim is sent to the attester to be reviewed."}),(0,a.jsx)("h2",{children:"Choose your claim type:"}),(0,a.jsx)("ul",{className:"flex flex-col gap-2 my-4",children:ed.map((t=>(0,a.jsx)("li",{children:(0,a.jsx)(u.Link,{className:"link link-primary",to:(0,u.generatePath)(td.paths.claim,{type:t}),children:nd[t].title})},t)))})]})}(0,c.createRoot)(document.querySelector("#app")).render((0,a.jsx)(u.BrowserRouter,{children:(0,a.jsxs)(u.Routes,{children:[(0,a.jsx)(u.Route,{path:td.paths.home,element:(0,a.jsx)(ud,{})}),(0,a.jsx)(u.Route,{path:td.paths.claim,element:(0,a.jsx)(hd,{})}),(0,a.jsx)(u.Route,{path:"*",element:(0,a.jsx)("p",{children:"404 - Not found"})})]})}));
//# sourceMappingURL=index.db009814.js.map
