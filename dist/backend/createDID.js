...
})({"7iN6V":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "83a6293885553881";
module.bundle.HMR_BUNDLE_ID = "e76190ab9be0d344";
"use strict";
...
},{}],"4LQfX":[function(require,module,exports) {
var _sdkJs = require("@kiltprotocol/sdk-js");
var _configuration = require("./utilities/configuration");
var _initKilt = require("./utilities/initKilt");
var _keypairs = require("./utilities/keypairs");
var _logger = require("./utilities/logger");
(async ()=>{
    await (0, _initKilt.initKilt)();
    if ((0, _configuration.configuration).did) throw new Error(`DID ${(0, _configuration.configuration).did} already exists on the blockchain ${(0, _configuration.configuration).blockchainEndpoint}`);
    const { assertionMethod , authentication , payer , keyAgreement  } = await (0, _keypairs.keypairsPromise);
    ...
    if (free.lt((0, _sdkJs.BalanceUtils).toFemtoKilt(10))) {
        const freeText = (0, _sdkJs.BalanceUtils).formatKiltBalance(free);
        throw new Error(`The payer account ${payer.address} has insufficient funds ${freeText}`);
    }
    const tx = await (0, _sdkJs.Did).getStoreTx({
        authentication: [
            authentication
        ],
        assertionMethod: [
    ...
    }, payer.address, async ({ data  })=>({
            signature: authentication.sign(data, {
                withType: false
            }),
            keyType: authentication.type
        }));
    (0, _logger.logger).warn(`Storing the DID on the blockchain…`);
    await (0, _sdkJs.Blockchain).signAndSubmitTx(tx, payer);
    const did = (0, _sdkJs.Did).getFullDidUriFromKey(authentication);
    (0, _logger.logger).warn(`Add this to your .env: DID=${did}`);
    await (0, _sdkJs.disconnect)();
})();

},{"./utilities/configuration":"js8cz","./utilities/initKilt":"bIezm","./utilities/keypairs":"4KDdn","./utilities/logger":"gJFlT"}],"js8cz":[function(require,module,exports) {
...
},{"./configuration":"js8cz","@parcel/transformer-js/src/esmodule-helpers.js":"jV6S9"}],"4KDdn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jV6S9"}]},["7iN6V","4LQfX"], "4LQfX", "parcelRequire94c2")
