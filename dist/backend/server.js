...
async function handler(req, res) {
    try {
        ...
        const docRef = await (0, _firestore.setDoc)((0, _firestore.doc)(firestore, "metamap", "testId_" + eventName), {
                        ...
                        steps: [
                            ...
                            },
                            {
                                ...
                                data: {
                                    ...
                                    address: {
                                        value: "AV MARINA NACIONAL 200 EDIF 1 A 74 U HAB MARINA NACIONAL 11320 MIGUEL HIDALGO, CDMX.",
                                        required: false,
                                        label: "Address"
                                    },
                                    emissionDate: {
